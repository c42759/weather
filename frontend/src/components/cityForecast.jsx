    ...
    return (
        <div className={"col-span-2"}>
            ...
            <div>
                <div className={"grid grid-cols-2 gap-4 pt-6"}>
                    ...
                    <div className={"grid grid-cols-2 text-center"}>
                        <div className={"border-r border-r-gray-300"}>
                            <span className={"text-gray-400 mr-4"}>min</span> 12º
                        </div>
                        <div>
                            <span className={"text-gray-400 mr-4"}>max</span> 25º
                        </div>
                    </div>
                </div>
                <div className={"grid grid-cols-2 gap-4 pt-6"}>
                ...
                <div className={"grid grid-cols-2 gap-4 pt-6"}>
                    <div className={"text-gray-400"}>wednesday</div>
                    <div className={"grid grid-cols-2 text-center"}>
                        <div className={"border-r border-r-gray-300"}>
                            <span className={"text-gray-400 mr-4"}>min</span> 12º
                        </div>
                ...
                <div className={"grid grid-cols-2 gap-4 pt-6"}>
                    <div className={"text-gray-400"}>thursday</div>
                    <div className={"grid grid-cols-2 text-center"}>
                        <div className={"border-r border-r-gray-300"}>
                            <span className={"text-gray-400 mr-4"}>min</span> 12º
                        </div>
                ...
                <div className={"grid grid-cols-2 gap-4 pt-6"}>
                    <div className={"text-gray-400"}>friday</div>
                    <div className={"grid grid-cols-2 text-center"}>
                        <div className={"border-r border-r-gray-300"}>
                            <span className={"text-gray-400 mr-4"}>min</span> 12º
                        </div>
